...
if( have_rows('section') ) {
	while ( have_rows('section') ) : the_row();
		...
		if (get_row_layout() == 'fullimg' ) { ?>
			<section class="fullimg titlesection" style="background-attachment:fixed; background-image : url(<?php echo get_sub_field('image'); ?>)" <?php if(get_sub_field('id')){echo 'id="' . get_sub_field('id') .'"'; } ?>>
				<div class="titlecontent"><?php echo get_sub_field('text'); ?></div>
			</section>
		<?php }

		if (get_row_layout() == 'slider') { ?>
			<section style="background:white" class="slider " <?php if(get_sub_field('id')){echo 'id="' . get_sub_field('id') .'"'; } ?>>
				...
				<ul class="bxslider" style="height:100%">
					<?php while ( have_rows('slide') ) : the_row();
						...
						<?php }
						elseif (get_sub_field('slide_type')=='image'){ ?>
						...
						<div class="fullimgli"><div class="titlecontent"><div class="container"><?php echo get_sub_field('text'); ?></div></div></div>
							</li>
		...
		elseif (get_row_layout() == 'gmap') {
			...
			<section <?php if(get_sub_field('id')){echo 'id=' . get_sub_field('id'); } ?> class="mapcontainer" >
				<address>
		...
		<?php }
			...
			elseif (get_row_layout() == 'partners-bak') { ?>
				<section class="partenaires" style="background-color:<?php # echo get_sub_field('background_color');?>#fff" <?php if(get_sub_field('id')){echo 'id=' . get_sub_field('id'); } ?>>
					...
					<?php while ( have_rows('partner') ) : the_row(); ?>
						<a href="#<?php echo 'partner' . $i; ?>" class="partnerlogos <?php if($i==1){echo'visible_partner';} ?>  ">
					...
					<?php $i=1;?>
					<?php while ( have_rows('partner') ) : the_row(); ?>
						<div class="partnerdescription <?php if($i==1){echo'displayed';} ?>" id="<?php echo 'partner' . $i; ?>">
		...
		<?php  $has_brochure = get_field('brochure');  $link_text = false;  ?>
		...
		<?php $contact_lots = array(); ?>
			...
			<section id="lots" class="price_list" style="display:table; width:100%; background-color: white;">
				<div style="display:table-cell; width:100%; vertical-align:middle; ">
						<h2 style="text-align:center; margin-top:30px;color: #276084;"><?php if(get_sub_field('title')){the_sub_field('title'); } else{ echo 'Liste des Prix';} ?> </h2>
						...
						<table>
							<thead>
								<tr>
									...
									<?php if ( in_array( 'statut', $fields ) OR in_array( 'price', $fields )) {
										if ( in_array( 'price', $fields )){ ?><th>Prix</th><?php }
										elseif ( in_array( 'rent', $fields )){ ?><th>Loyer<span class="expendable">/mois</span></th><?php }
										else { ?><th>Statut</th><?php } ?>
									<?php } ?>
							...
							<tbody>
								...
								<tr>
									<td><?php if(get_sub_field('number')){the_sub_field('number');} else {echo'-'; } ?></td>

									<?php if ( in_array( 'rooms', $fields ) ) { ?>
										<td><?php if(get_sub_field('rooms')){the_sub_field('rooms');} else {echo'-'; } ?></td>
									<?php } ?>
									<?php if ( in_array( 'orientation', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('orientation')){the_sub_field('orientation');} else {echo'-'; } ?></td>
									<?php } ?>
									<?php if ( in_array( 'floor', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('floor')){the_sub_field('floor');} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'ppe', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('ppe')){the_sub_field('ppe'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'ponderee', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('ponderee')){the_sub_field('ponderee'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'sbp', $fields ) ) { ?>
										<td><?php if(get_sub_field('sbp')){the_sub_field('sbp'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'sh', $fields ) ) { ?>
										<td><?php if(get_sub_field('sh')){the_sub_field('sh');echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'su', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('su')){the_sub_field('su');} else {echo'-'; } ?></td>
									<?php } ?>


									<?php if ( in_array( 'surface_parcelle', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('surface_parcelle')){the_sub_field('surface_parcelle'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'surface_jardin', $fields ) OR in_array( 'sbp', $fields )) { ?>
										<td class="expendable"><?php if(get_sub_field('surface_jardin')){the_sub_field('surface_jardin'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'surface_balcon', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('surface_balcon')){the_sub_field('surface_balcon'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'surface_terrasse', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('surface_terrasse')){the_sub_field('surface_terrasse'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'surface_veranda', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('surface_veranda')){the_sub_field('surface_veranda'); echo " m<span class='m2'>2</span>";} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'cave', $fields ) ) { ?>
										<td><?php if(get_sub_field('cave')){the_sub_field('cave');} else {echo'-'; } ?></td>
									<?php } ?>

									<?php if ( in_array( 'parking', $fields ) ) { ?>
										<td><?php if(get_sub_field('parking')){the_sub_field('parking');} else {echo'-'; } ?></td>
									<?php } ?>
									...
									<?php if ( in_array( 'statut', $fields ) OR in_array( 'price', $fields ) OR in_array( 'rent', $fields ) ) { ?>
										<td><?php if(get_sub_field('statut')){
											...
											elseif ($statut == 'prebooked'){echo '<span class="prebooked">Pré</span>-réservé';}
											elseif ($statut == 'booked'){echo '<span class="booked">Réservé</span>';}
											elseif ($statut == 'sold'){echo '<span class="sold">Vendu</span>';}
										} else {echo'-'; } ?></td>
									<?php } ?>
									<?php if ( in_array( 'bills', $fields ) ) { ?>
										<td class="expendable"><?php if(get_sub_field('bills')){the_sub_field('bills');} else {echo'-'; } ?></td>
									<?php } ?>
...
<?php endif; ?>
		...
		<?php }
		elseif (get_row_layout() == 'cartes') { include('markers_map.php'); } ?>
